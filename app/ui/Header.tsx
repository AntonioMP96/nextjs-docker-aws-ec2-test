  ...
  return (
    <header className="text-white body-font">
      <div className="container mx-auto flex flex-wrap p-5 md:flex-row">
        ...
        <button className="px-4 py-2 mt-2 text-sm font-semibold text-white bg-green-500 transition duration-500 ease-in-out transform rounded-lg md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-gray-100 focus:bg-gray-200 focus:outline-none focus:shadow-outline">
          Contacto
        </button>
        </div>
      </div>
